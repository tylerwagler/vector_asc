...
BOOST_AUTO_TEST_CASE(LogFile)
{
    ...
    /* open file */
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/logfile.asc");
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/FileDate.asc");
    BOOST_REQUIRE(file.is_open());
    ...
    BOOST_CHECK(fileDate->date.tm_year == 2008);
    delete event;
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/FileBaseTimestamps.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/FileInternalEventsLogged.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/FileVersion.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/FileSplitInformation.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/FileComment.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/CanMessageEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/CanExtendedMessageEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/CanRemoteFrameEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/CanErrorFrame.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/CanBusStatisticsEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/CanErrorEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/CanOverloadFrameEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/CanFdMessageEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/CanFdExtendedMessageEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/CanFdErrorFrame.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LogTriggerEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LogDirectStartEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LogDirectStopEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/BeginTriggerblockEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/EndTriggerblockEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/EnvironmentVariablesEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/SystemVariablesEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/MacroSignalEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/GpsEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/CommentEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/GlobalMarkerEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/EthernetPacket.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/EthernetStatus.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/EthernetRxError.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/AfdxPacket.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/FlexRayOldMessageEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/FlexRayOldStartCycleEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/FlexRayMessageEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/FlexRayStartCycleEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/FlexRayStatusEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/FlexRayErrorEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/KLineByteEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/KLineMessageEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LinMessage.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LinTransmissionError.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LinReceiveError.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LinSyncError.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LinChecksumError.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LinSpikeEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LinDominantSignal.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LinBaudrate.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LinDlcInfo.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LinChecksumInfo.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LinSchedulerModeChange.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LinSlaveTimeout.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LinEventTriggeredFrameInfo.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LinStatisticInfo.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LinShortOrSlowResponse.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LinDisturbanceEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LinSleepMode.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LinWakeupFrame.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/LinUnexpectedWakeup.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/Most25ControlMessageNodeMode.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/Most25ControlMessageSpyMode.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/Most25Packet.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/MostLightLockEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/MostSpecialRegisterEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/MostCommonRegisterEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/MostHwModeEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/MostNetStateEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/MostDataLostEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/MostTriggerEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/MostStatisticEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/MostStatisticExtendedEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/MostTxLight.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/MostStressEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/Most25AllocTable.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/Most150ControlMessage.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/Most150ControlMessageFragment.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/Most150Packet.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/Most150PacketFragment.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/MostEthernetPacket.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/MostEthernetPacketFragment.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/MostSystemEvent.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/Most150AllocTable.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/Most50ControlMessage.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/Most50Packet.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/MostEcl.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/TpDiagPrefix.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/TpDiagSingleFrame.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/TpDiagFirstFrame.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/TpDiagConsecutiveFrame.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/TpDiagFlowControlFrame.asc");
    BOOST_REQUIRE(file.is_open());
...
{
    Vector::ASC::File file;
    file.open(CMAKE_CURRENT_SOURCE_DIR "/data/TpDiagRequest.asc");
    BOOST_REQUIRE(file.is_open());

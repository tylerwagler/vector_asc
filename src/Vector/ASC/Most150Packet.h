 ...
 */
struct VECTOR_ASC_EXPORT Most150Packet final : Event {
    Most150Packet() : Event(EventType::Most150Packet) {}
    ...
    MostPkt150Len pkt150Len {0};

    /** @copydoc MostDx */
    std::vector<MostDx> data {};

    /** @copydoc Event::read() */
    static Most150Packet * read(File & file, std::string & line);
